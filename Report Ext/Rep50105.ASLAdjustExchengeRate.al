report 50105 "ASL Adjust Exchenge Rate"
{
    ApplicationArea = Basic, Suite;
    Caption = 'ASL Adjust Exchange Rates';
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(AdjCustomer; AdjCust)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Adjust Customer Accounts and Bank Accounts';
                        MultiLine = true;
                        ToolTip = 'Specifies if you want to adjust customer for currency fluctuations.';
                    }
                    field(AdjVendor; AdjVend)
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Adjust Vendor and Bank Accounts';
                        MultiLine = true;
                        ToolTip = 'Specifies if you want to adjust vendor, and bank accounts for currency fluctuations.';
                    }
