table 50006 "Payroll-Payslip Lines."
{
    ...
    begin
        ...
        ChangeOthers := false;
        // ChangeDueToDelete(Rec); //Revisit

        /* Set the 'Change' flags to false in all the lines */
        // ResetChangeFlags(Rec); //Revisit
    ...
    //[Scope('OnPrem')]
    procedure CalcAmount(EDFileRec: Record "Payroll ED Codes."; EntryLineRec: Record "Payroll-Payslip Lines."; EntryLineAmount: Decimal; EDCode: Code[20]): Decimal
    begin
        /*””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””””
