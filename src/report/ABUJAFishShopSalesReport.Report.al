report 50222 "ABUJA Fish Shop Sales Report."
{
    ...
    dataset
    {
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            column(Abuja_Fish_Shop_Sales_ReportCaption; Abuja_Fish_Shop_Sales_ReportCaptionLbl)
            {
            }
    ...
    var
        ...
        Abuja_Fish_Shop_Sales_ReportCaptionLbl: Label 'Abuja Fish Shop Sales Report';
