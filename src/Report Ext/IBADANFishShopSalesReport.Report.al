report 50232 "IBADAN Fish Shop Sales Report"
{
    // "Sea Food categories"
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            column(Ibadan_Fish_Shop_Sales_ReportCaption; Ibadan_Fish_Shop_Sales_ReportCaptionLbl)
            {
            }
    ...
    var
        ...
        Ibadan_Fish_Shop_Sales_ReportCaptionLbl: Label 'Ibadan Fish Shop Sales Report';
