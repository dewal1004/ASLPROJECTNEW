...
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/LocalSalesReport1.rdlc';
    ...
    dataset
    {
        ...
        dataitem("Integer"; "Integer")
        {
            ...
            column(SalesKGS; Item."Sales (Qty.)")
            {
            }
            ...
            begin
                ...
                if Item2.Get(Item."No.") then begin
                    ...
                    //Item2.SETRANGE(Item2."Date Filter",CALCDATE('-1D',Predate));
                ...
                TStk := OpStk + Recpt;
                CurrReport.ShowOutput(Item."Sales (LCY)" > 0);
            end;
    ...
    var
        ...
        Text006: Label 'Item:Date Filter:%1';
