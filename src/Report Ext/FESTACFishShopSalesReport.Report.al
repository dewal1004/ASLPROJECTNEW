report 50231 "FESTAC Fish Shop Sales Report"
{
    //   "Sea Food categories"
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/FESTACFishShopSalesReport.rdlc';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All, Basic, Suite;
    Caption = 'FESTAC Fish Shop Sales Report';
    dataset
    {
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            column(Festac_Fish_Shop_Sales_ReportCaption; Festac_Fish_Shop_Sales_ReportCaptionLbl)
            {
            }
    ...
    var
        ...
        Festac_Fish_Shop_Sales_ReportCaptionLbl: Label 'Festac Fish Shop Sales Report';
