report 50082 "Catch Reconsiliation Statement"
{
        ...
        dataitem("Job Journal Batch"; "Job Journal Batch")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Job Journal Line"; "Job Journal Line")
                {
                    ...
                    column(DataItem1000000028; KNOWINGLbl)
                    {
                    }
    ...
    var
        ...
        KNOWINGLbl: Label 'KNOWING THAT WE CAN BE HELD LIABLE FOR FALSIFYING INFORMATION, WE CERTIFY THIS REPORT TO BE TRUE AND ACCURATE TO THE BEST OF OUR KNOWLEDGE';
