...
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/LocalBanksReport.rdlc';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All, Basic, Suite;
    Caption = 'Local Banks Report';
    dataset
    {
        dataitem("Bank Account"; "Bank Account")
        {
            ...
            column(Local_Bank_ReportCaption; Local_Bank_ReportCaptionLbl)
            {
            }
        ...
        dataitem(DEPOSIT; DEPOSIT)
        {
            ...
            column(DEPOSIT__Deposit_Balance__Control1000000067; "Deposit Balance")
            {
            }
            ...
            column(DEPOSIT_Bank_Acc__No_; "Bank Acc. No.")
            {
            }
        }
    }
    ...
    var
        ...
        Local_Bank_ReportCaptionLbl: Label 'Local Bank Report';
