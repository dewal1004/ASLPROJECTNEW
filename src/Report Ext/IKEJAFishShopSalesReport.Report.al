report 50224 "IKEJA Fish Shop Sales Report"
{
    //   "Sea Food categories"
    DefaultLayout = RDLC;
    RDLCLayout = './src/reportrdlc/IKEJAFishShopSalesReport.rdlc';
    UsageCategory = ReportsAndAnalysis;
    ApplicationArea = All, Basic, Suite;
    Caption = 'IKEJA Fish Shop Sales Report';
    dataset
    {
        dataitem("Sea Food categories"; "Sea Food categories")
        {
            ...
            column(Ikeja_Fish_Shop_Sales_ReportCaption; Ikeja_Fish_Shop_Sales_ReportCaptionLbl)
            {
            }
            ...
            dataitem(Item; Item)
            {
                DataItemTableView = SORTING("SF Cat", "No. 2") WHERE("Gen. Prod. Posting Group" = FILTER('FIS'), "Sales (Qty.)" = FILTER(<> 0), "Location Filter" = FILTER('IKFISHSHOP'));
    ...
    var
        ...
        Ikeja_Fish_Shop_Sales_ReportCaptionLbl: Label 'Ikeja Fish Shop Sales Report';
