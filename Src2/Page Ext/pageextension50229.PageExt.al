pageextension 50229 pageextension50229 extends "Location List"
{
    layout
    {
        ...
        addafter(ASLName)
        {
            ...
            // field("Voyage Sea Days"; "Voyage Sea Days") {Visible = false;}
            // field("Current Operation"; "Current Operation") {}
            // field("Current Voyage"; "Current Voyage") {Visible = false;}
            // field(VSDVal; VSDVal) {}
            // field("Shortcut Dimension 2 Code"; "Shortcut Dimension 2 Code") {Visible = false;}
            // field(Values; Values) {}
            ...
            // field(Captain; rec.ASLCaptain) {Visible = false;}
            ...
            // field("Ves Age"; "Ves Age") {Visible = false;}
